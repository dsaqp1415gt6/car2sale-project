...
public class MarcaDetailActivity extends ListActivity {
    private final static String TAG = MarcaDetailActivity.class.toString();
    ...
    private class FetchAnunciosTask extends
        ...
        protected AnuncioCollection doInBackground(String... params) {
            ...
            try {
            anuncios = Car2SaleAPI.getInstance(MarcaDetailActivity.this)
                    .getMarca(params[0]);
        ...
        protected void onPreExecute() {
            pd = new ProgressDialog(MarcaDetailActivity.this);
