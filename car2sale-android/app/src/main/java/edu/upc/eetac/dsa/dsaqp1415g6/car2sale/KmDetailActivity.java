...
public class KmDetailActivity extends ListActivity {
    private final static String TAG = KmDetailActivity.class.toString();
    ...
    private class FetchAnunciosTask extends
        ...
        protected AnuncioCollection doInBackground(String... params) {
            ...
            try {
                anuncios = Car2SaleAPI.getInstance(KmDetailActivity.this)
                        .getKms(params[0]);
        ...
        protected void onPreExecute() {
            pd = new ProgressDialog(KmDetailActivity.this);
