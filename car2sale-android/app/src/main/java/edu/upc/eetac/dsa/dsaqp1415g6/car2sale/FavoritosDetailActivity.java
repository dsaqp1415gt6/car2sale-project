...
public class FavoritosDetailActivity extends ListActivity {

    private final static String TAG = FavoritosDetailActivity.class.toString();
    ...
    private class FetchAnunciosTask extends
        ...
        protected AnuncioCollection doInBackground(String... params) {
            ...
            try {
                anuncios = Car2SaleAPI.getInstance(FavoritosDetailActivity.this)
                        .getMisFavoritos();
        ...
        protected void onPreExecute() {
            pd = new ProgressDialog(FavoritosDetailActivity.this);
