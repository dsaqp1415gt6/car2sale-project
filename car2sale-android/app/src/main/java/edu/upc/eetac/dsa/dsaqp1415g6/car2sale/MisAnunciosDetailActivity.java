...
public class MisAnunciosDetailActivity extends ListActivity {
    private final static String TAG = MisAnunciosDetailActivity.class.toString();
    ...
    private class FetchAnunciosTask extends
        ...
        protected AnuncioCollection doInBackground(String... params) {
            ...
            try {
                anuncios = Car2SaleAPI.getInstance(MisAnunciosDetailActivity.this)
                        .getMisAnuncios();
        ...
        protected void onPreExecute() {
            pd = new ProgressDialog(MisAnunciosDetailActivity.this);
